...
# Define summarizer function using OpenAI v1.x syntax
...
# Updated feed URL to cover 5 companies
...
# Updated default watchlist with 5 tickers
...
# Updated Sector Mapping for 5 companies
sector_map = {
    'AAPL': 'Technology',
    'TSLA': 'Automotive',
    'MSFT': 'Technology',
